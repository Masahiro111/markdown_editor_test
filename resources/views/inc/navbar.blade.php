<nav class="flex items-center justify-between flex-wrap bg-black p-3 fixed w-full z-10 top-0 pin-t">
    ...
    <div class="block lg:hidden">
        <button id="nav-toggle"
            ...
            <svg class="fill-current mb-2 font-medium leading-tight text-2xl w-3" viewBox="0 0 20 20"
    ...
    <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block pt-6 lg:pt-0" id="nav-content">
        <ul class="list-reset lg:flex justify-end flex-1 items-center">
            ...
            <li class="mr-6">
                <a class="inline-block text-white no-underline hover:text-blue-300 hover:text-underline py-2 px-2"
                    href="#">About</a>
            </li>
            <li class="mr-6">
                <a class="inline-block text-white no-underline hover:text-blue-300 hover:text-underline py-2 px-2"
